...
type LoginRequest struct {
	...
	AppId    int32  `protobuf:"varint,3,opt,name=app_id,json=appId,proto3" json:"app_id,omitempty"` // Id приложения, куда входит
}
...
type IsAdminRequest struct {
	...
	UserId int64 `protobuf:"varint,1,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"` // id пользователя для провекри
}
...
type IsAdminResponse struct {
	...
	IsAdmin bool `protobuf:"varint,1,opt,name=is_admin,json=isAdmin,proto3" json:"is_admin,omitempty"` // Является ли пользователь админом
}
...
var file_sso_sso_proto_rawDesc = []byte{
	...
	0x5a, 0x15, 0x6e, 0x69, 0x63, 0x6b, 0x6f, 0x6c, 0x61, 0x79, 0x2e, 0x73, 0x73, 0x6f, 0x2e, 0x76,
